                ...
                <div className="card-body p-5 text-center">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="form-outline mb-4">
                      <input type="email" className="form-control form-control-lg" style={{ background: "#f4f5f7" }} value={email} onChange={(e) => setEmail(e.target.value)} />
                      <label className="form-label" style={{ marginBottom: "-20px" }}>Email</label>
                    </div>
                    <div className="form-outline mb-4">
                      <input type="password" className="form-control form-control-lg" style={{ background: "#f4f5f7" }} value={password} onChange={(e) => setPassword(e.target.value)} />
